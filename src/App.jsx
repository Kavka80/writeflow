    ...
    try {
      const response = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          ...
          messages: [{
            role: "user",
            content: buildPrompt({ type, tone, length, context, recipient, sender })
          }]
        })
      });
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 18, fontWeight: 700, letterSpacing: "-0.3px" }}>
              WriteFlow
            </div>
            <div style={{ fontSize: 11, color: "#6b7280", fontWeight: 400, marginTop: -1 }}>AI pisni asistent</div>
          </div>
        </div>
        <div style={{
          fontSize: 12, color: "#4b5563",
          background: "#1a1a24", borderRadius: 20, padding: "5px 12px",
      ...
      <div style={{ maxWidth: 880, margin: "0 auto", padding: "32px 20px 80px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <h1 style={{
            ...
            Profesionalna besedila<br />
< truncated lines 190-221 >
            ))}
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 28 }}>
          <div>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 7 }}>
              {TONES.map(t => (
                <button key={t.id} className="pill-btn" onClick={() => setTone(t.id)} style={{
                  background: tone === t.id ? "#8b5cf6" : "#1e1e2e",
                  color: tone === t.id ? "white" : "#9ca3af",
                  border: `1px solid ${tone === t.id ? "#8b5cf6" : "#2a2a3a"}`,
                  borderRadius: 20, padding: "6px 14px", fontSize: 13, fontFamily: "inherit",
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 7 }}>
              {LENGTHS.map(l => (
                <button key={l.id} className="pill-btn" onClick={() => setLength(l.id)} style={{
                  background: length === l.id ? "#06b6d4" : "#1e1e2e",
                  color: length === l.id ? "white" : "#9ca3af",
                  border: `1px solid ${length === l.id ? "#06b6d4" : "#2a2a3a"}`,
                  borderRadius: 20, padding: "6px 14px", fontSize: 13, fontFamily: "inherit",
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 20 }}>
          <div>
            ...
            <input
              ...
              placeholder="npr. g. Novak, stranka, tim..."
              style={{
                width: "100%", background: "#18181f", border: "1.5px solid #2a2a3a",
          ...
          <div>
            <div style={{ fontSize: 11, color: "#6b7280", textTransform: "uppercase", letterSpacing: "1px", marginBottom: 8, fontWeight: 600 }}>Podpis / pošiljatelj (neobvezno)</div>
            <input
              value={sender}
              onChange={e => setSender(e.target.value)}
              placeholder="npr. Ana Kovač, prodajni tim..."
              style={{
                width: "100%", background: "#18181f", border: "1.5px solid #2a2a3a",
                borderRadius: 10, padding: "10px 14px", color: "#e8e8f0",
                fontSize: 14, fontFamily: "inherit",
        ...
        <div style={{ marginBottom: 20 }}>
          <div style={{
            ...
            <div style={{ fontSize: 11, color: "#6b7280", textTransform: "uppercase", letterSpacing: "1px", fontWeight: 600 }}>
              Kaj želite sporočiti? *
            </div>
            <div style={{ fontSize: 11, color: charCount > 400 ? "#f59e0b" : "#4b5563" }}>
              {charCount}/500
            </div>
          </div>
          <textarea
            ...
            placeholder="Opišite vsebino... npr. 'Obvestiti stranko, da je naročilo zamujeno za 3 dni zaradi dobavnih težav. Opravičiti se in ponuditi 10% popust na naslednje naročilo.'"
            maxLength={500}
            rows={5}
            style={{
              width: "100%", background: "#18181f", border: "1.5px solid #2a2a3a",
              borderRadius: 12, padding: "14px 16px", color: "#e8e8f0",
        ...
        <button
          ...
          style={{
            ...
            background: !context.trim() || loading
              ? "#2a2a3a"
              : "linear-gradient(135deg, #8b5cf6, #06b6d4)",
            border: "none", borderRadius: 12,
            color: !context.trim() || loading ? "#6b7280" : "white",
            fontSize: 15, fontWeight: 700, cursor: !context.trim() || loading ? "not-allowed" : "pointer",
            fontFamily: "inherit", letterSpacing: "0.3px",
            boxShadow: !context.trim() || loading ? "none" : "0 4px 20px rgba(139,92,246,0.3)",
        ...
        {result && (
          <div className="fade-up" style={{ marginTop: 32 }}>
            <div style={{
              ...
              <div style={{ fontSize: 13, fontWeight: 600, color: "#c4b5fd", display: "flex", alignItems: "center", gap: 7 }}>
                <span style={{
              ...
              <div style={{ display: "flex", gap: 8 }}>
                <button className="copy-btn" onClick={copy} style={{
                  ...
                  padding: "7px 14px", color: copied ? "#10b981" : "#9ca3af",
                  fontSize: 13, cursor: "pointer", fontFamily: "inherit", fontWeight: 500
                }}>
                  {copied ? "✓ Kopirano!" : "📋 Kopiraj"}
                </button>
                <button className="copy-btn" onClick={reset} style={{
                  background: "#1e1e2e", border: "1px solid #2a2a3a", borderRadius: 8,
                  padding: "7px 14px", color: "#9ca3af",
            ...
            <div style={{ marginTop: 10, fontSize: 12, color: "#4b5563", textAlign: "right" }}>
              💡 Besedilo je pripravljeno za kopiranje. Po potrebi prilagodite detajle.
            </div>
          </div>
        )}
      </div>
